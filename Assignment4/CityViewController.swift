...
class CityViewController: UIViewController {
    ...
    @objc func showWeatherDetails() {
        ...
        detailView.propsContainerCountry = city.icon
        detailView.propsContainerCity = city.name
        detailView.propsContainerTemperature = String(format: "%.1f", city.temp)
        detailView.propsContainerSummary = city.summary
